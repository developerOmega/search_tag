class SearchTag{
    ...
    tags(){
       ...
       //Ciclo que genera los div de todos los usuarios existentes; los div se guardan en la variable 'options'
        ...
        //Evento 'keyup'; se ejecuta cada vez que se escribe un caracter en el input que está guardado en la propiedad 'field'; invoca el método searchTags y recibe el parámetro de la varibe 'option' 
